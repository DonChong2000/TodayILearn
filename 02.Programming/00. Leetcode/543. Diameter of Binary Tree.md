...
```
I tried to create a depth table before doing the whole search, yet the testcase does contain node with the same value, therefore could not pass the test.
